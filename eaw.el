;; put eaw.el to ~/.emacs.d/site-lisp/ 
;; 
;; in .emacs 
;; 
...
;; (eaw-fullwidth)
;;
;;  this is modified version of https://github.com/hamano/locale-eaw
;;     kono@ie.u-ryukyu.ac.jp <kono@ie.u-ryukyu.ac.jp>
;;   

(setq east-asian-ambiguous-1 '(
...
(defvar eaw-japanese-width 2 "default for some part of east asian amiguous width char.")
...
(defun eaw-set-width (width)
  ...
  (when (>= emacs-major-version 23)
    ...
    (let ((table (make-char-table nil)))
      ...
      (mapc (lambda (range) (set-char-table-range table range eaw-japanese-width))
