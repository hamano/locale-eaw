...
static const struct {
    ...
    {"△", "▵"}, // U+25B3 WHITE UP-POINTING TRIANGLE -> U+25B5 WHITE UP-POINTING SMALL TRIANGLE
    {"▼", "▾"}, // U+25BC BLACK DOWN-POINTING TRIANGLE -> U+25BE SMALL BLACK DOWN-POINTING TRIANGLE
    {"▽", "▿"}, // U+25BD WHITE DOWN-POINTING TRIANGLE -> U+25BF WHITE DOWN-POINTING SMALL TRIANGLE
